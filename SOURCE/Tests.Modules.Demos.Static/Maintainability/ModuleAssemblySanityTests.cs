using Tests.Modules.Demos.Static.Helpers;

namespace Tests.Modules.Demos.Static.Maintainability
{
	/// <summary>
	/// ISO-25010 Maintainability.Modularity — Module Assembly Sanity.
	/// Validates basic structural health of the Demos module.
	/// </summary>
	public class ModuleAssemblySanityTests
	{
		...
		/// </summary>
		[Fact]
		[Trait(TestTraits.Type, TestTraits.Types.Static)]
		[Trait(TestTraits.Domain, TestTraits.Domains.Assembly)]
