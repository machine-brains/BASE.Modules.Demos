...
namespace Tests.Modules.Demos.Static.Helpers
{
	/// <summary>
	/// Provides reflection-based access to all Demos module assemblies
	/// for static proof tests.
	/// <para>
	/// Caches assembly metadata to avoid repeated loading.
	/// All static tests use this to scan types, methods, and attributes.
	/// </para>
	/// </summary>
	public static class AssemblyUnderTest
	{
		/// <summary>
		/// All Demos module production assemblies (non-test).
		/// </summary>
		...
		private static List<Assembly> LoadAll()
		{
			...
			return AppDomain.CurrentDomain.GetAssemblies()
				.Where(a =>
				{
					...
					return name.Contains("App.Modules.Demos", StringComparison.OrdinalIgnoreCase)
