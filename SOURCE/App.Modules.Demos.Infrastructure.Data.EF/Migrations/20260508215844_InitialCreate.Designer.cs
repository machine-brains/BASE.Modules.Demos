...
namespace App.Modules.Demos.Infrastructure.Migrations
{
    ...
    [Migration("20260508215844_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Modules.Demos.Domain.Domains.Creations.Models.CreativeMediumReferenceData", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_CreativeMediumReferenceData_Id");
                    ...
                    b.HasIndex("RecordState")
                        .HasDatabaseName("IX_CreativeMediumReferenceData_RecordState");

                    b.HasIndex("ReferenceDataType")
                        .HasDatabaseName("IX_CreativeMediumReferenceData_ReferenceDataType");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a9a5d5ba-39f7-e720-b5f1-3c5192f4bb69"),
            ...
            modelBuilder.Entity("App.Modules.Demos.Domain.Domains.Influences.Models.InfluenceStrengthReferenceData", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(1)
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_InfluenceStrengthReferenceData_Id");
                    ...
                    b.HasIndex("RecordState")
                        .HasDatabaseName("IX_InfluenceStrengthReferenceData_RecordState");

                    b.HasIndex("ReferenceDataType")
                        .HasDatabaseName("IX_InfluenceStrengthReferenceData_ReferenceDataType");
            ...
            modelBuilder.Entity("App.Modules.Demos.Domain.Domains.Influences.Models.InfluenceTypeReferenceData", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(1)
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_InfluenceTypeReferenceData_Id");
                    ...
                    b.HasIndex("RecordState")
                        .HasDatabaseName("IX_InfluenceTypeReferenceData_RecordState");

                    b.HasIndex("ReferenceDataType")
                        .HasDatabaseName("IX_InfluenceTypeReferenceData_ReferenceDataType");
            ...
            modelBuilder.Entity("App.Modules.Demos.Domain.Domains.ReferenceData.Models.ProfileTypeReferenceData", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(1)
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_ProfileTypeReferenceData_Id");
                    ...
                    b.HasIndex("RecordState")
                        .HasDatabaseName("IX_ProfileTypeReferenceData_RecordState");

                    b.HasIndex("ReferenceDataType")
                        .HasDatabaseName("IX_ProfileTypeReferenceData_ReferenceDataType");
            ...
            modelBuilder.Entity("App.Modules.Demos.Shared.Domains.Contributions.Models.Contribution", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(0)
            ...
            modelBuilder.Entity("App.Modules.Demos.Shared.Domains.Contributions.Models.Creation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(0)
            ...
            modelBuilder.Entity("App.Modules.Demos.Shared.Domains.Contributions.Models.Discovery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(0)
            ...
            modelBuilder.Entity("App.Modules.Demos.Shared.Domains.Profiles.Models.BelieverProfile", b =>
                {
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_BelieverProfile_Id");

                    b.HasIndex("PersonId")
                        .HasDatabaseName("IX_BelieverProfile_PersonId");

                    b.HasIndex("RecordState")
                        .HasDatabaseName("IX_BelieverProfile_RecordState");
            ...
            modelBuilder.Entity("App.Modules.Demos.Shared.Domains.Profiles.Models.CreatorProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(0)
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_CreatorProfile_Id");

                    b.HasIndex("PersonId")
                        .HasDatabaseName("IX_CreatorProfile_PersonId");

                    b.HasIndex("RecordState")
                        .HasDatabaseName("IX_CreatorProfile_RecordState");
            ...
            modelBuilder.Entity("App.Modules.Demos.Shared.Domains.Profiles.Models.DiscovererProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(0)
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_DiscovererProfile_Id");

                    b.HasIndex("PersonId")
                        .HasDatabaseName("IX_DiscovererProfile_PersonId");

                    b.HasIndex("RecordState")
                        .HasDatabaseName("IX_DiscovererProfile_RecordState");
            ...
            modelBuilder.Entity("App.Modules.Demos.Shared.Domains.Relationships.Models.Influence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(0)
