...
{
    /// <summary>Maps InfluenceReadDto to Influence (for create/update operations). Discovered via IObjectMap scan.</summary>
    public class InfluenceDtoToInfluenceMap : ObjectMapBase<InfluenceReadDto, Influence>
    {
        /// <inheritdoc/>
