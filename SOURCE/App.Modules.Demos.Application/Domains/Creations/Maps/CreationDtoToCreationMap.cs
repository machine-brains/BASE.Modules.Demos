...
{
    /// <summary>Maps CreationReadDto to Creation (for create/update operations). Discovered via IObjectMap scan.</summary>
    public class CreationDtoToCreationMap : ObjectMapBase<CreationReadDto, Creation>
    {
        /// <inheritdoc/>
