...
{
	/// <summary>Maps CreatorProfile to CreatorProfileDto. Discovered via IObjectMap scan.</summary>
	public class CreatorProfileToCreatorProfileDtoMap : ObjectMapBase<CreatorProfile, CreatorProfileDto>
	{
		/// <inheritdoc/>
