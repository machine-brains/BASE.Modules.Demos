...
{
	/// <summary>Maps Discovery to DiscoveryReadDto. Discovered via IObjectMap scan.</summary>
	public class DiscoveryToDiscoveryDtoMap : ObjectMapBase<Discovery, DiscoveryReadDto>
	{
		/// <inheritdoc/>
