...
{
    /// <summary>Explicit write projection from ExampleBWriteDto to the Demos entity.</summary>
    /// <remarks>The parent identity, name, description, and order are writable; audit fields are not.</remarks>
