using App.Modules.Demos.Application.Domains.Examples.Dtos;
using App.Modules.Demos.Infrastructure.Data.EF;
...
namespace App.Modules.Demos.Application.Domains.Examples.Services.Implementations
{
    ...
    public class ExampleAApplicationService : IExampleAApplicationService
    {
        ...
        public ExampleAApplicationService(ModuleDbContext db, IObjectMappingService mapper)
        {
