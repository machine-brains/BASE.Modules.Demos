...
namespace App.Modules.Demos.Infrastructure.Domains.DbSeeders.Repositories.Profiles
{
    /// <summary>
    ...
    public class BelieverProfileRepository : CrustStateRepositoryBase<BelieverProfile>, IBelieverProfileRepository
    {
        ...
        /// </summary>
        public BelieverProfileRepository(IAppLogger logger, App.Modules.Demos.Infrastructure.Persistence.EF.ModuleDbContext dbContext)
