...
{
    /// <summary>Creates the Demos Examples tables used by the Spike consumer.</summary>
    public partial class AddExamples : Migration
    {
        /// <inheritdoc/>
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.EnsureSchema(name: "demos_examples");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false, comment: "The textual Description."),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, comment: "Whether the example is active."),
                    SysEndTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Stores the Sys End Time value for the ExampleA record.")
                        .Annotation("SqlServer:TemporalIsPeriodEndColumn", true),
                    SysStartTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Stores the Sys Start Time value for the ExampleA record.")
                ...
                comment: "Demos ExampleA parent records.")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateChangedOnDateTimeUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true, comment: "Gets or sets the date when record state changed (nullable for soft delete)."),
                    StateChangedByPrincipalId = table.Column<string>(type: "varchar(36)", unicode: false, maxLength: 36, nullable: true, comment: "Gets or sets the principal id who changed the state (nullable)."),
                    ExampleAId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Opaque identifier for the related ExampleA aggregate."),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false, comment: "The display name."),
                    Description = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true, comment: "The textual Description."),
                    SortOrder = table.Column<int>(type: "int", nullable: false, comment: "The deterministic order within the parent."),
                    SysEndTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Stores the Sys End Time value for the ExampleB record.")
                        .Annotation("SqlServer:TemporalIsPeriodEndColumn", true),
                    SysStartTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Stores the Sys Start Time value for the ExampleB record.")
                        .Annotation("SqlServer:TemporalIsPeriodStartColumn", true)
                },
                constraints: table =>
                {
                ...
                comment: "Demos ExampleB ordered child records.")
                .Annotation("SqlServer:IsTemporal", true)
        ...
        {
            migrationBuilder.DropTable(name: "example_b", schema: "demos_examples");
            migrationBuilder.DropTable(name: "example_a", schema: "demos_examples");
        }
    }
}